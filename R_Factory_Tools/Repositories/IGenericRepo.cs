...
public interface IGenericRepo
{
    ...
    Task<List<T>> FindByExpression<T>(Expression<Func<T, bool>> predicate, Func<IQueryable<T>, IOrderedQueryable<T>>? orderBy = null, int? skip = null, int? take = null) where T : class;
