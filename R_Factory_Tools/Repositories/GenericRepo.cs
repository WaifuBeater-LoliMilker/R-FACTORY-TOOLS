...
using R_Factory_Tools.Models.Context;
using R_Factory_Tools.Utilities;
using System.Data;
using System.Linq.Expressions;

namespace R_Factory_Tools.Repositories;

public class GenericRepo : IGenericRepo
{
    private readonly r_factoryContext _context;
    private readonly IDbConnection _dbConnection;

    public GenericRepo()
    {
        _context = new r_factoryContext();
        _dbConnection = new MySqlConnection(ConnectionStringProvider.Default);
    }
    ...
    public async Task<List<T>> FindByExpression<T>(
